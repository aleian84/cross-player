	...
	*/
	...
	$xmlInitiator=$xmlInitiator.
			...
			/*if ($cookie) {*/
				...
				$xmlInitiator=$xmlInitiator."<CustomData><Auth><cookie>".$_REQUEST["cookie"]."</cookie><contentId>".$_REQUEST["cpId"]."</contentId><type>".$_REQUEST["type"]."</type><channel>".$_REQUEST["channel"]."</channel><licenseType>streaming</licenseType></Auth></CustomData>";
			/*} else {
